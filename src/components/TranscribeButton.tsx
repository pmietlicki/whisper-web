...
export function TranscribeButton(props: Props): React.JSX.Element {
    ...
    return (
        <button
            ...
            aria-busy={isTranscribing || isModelLoading}
            className='text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus-visible:ring-4 focus-visible:ring-blue-300 disabled:cursor-not-allowed disabled:opacity-70 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus-visible:ring-blue-800 inline-flex items-center'
        >
            {isModelLoading ? (
